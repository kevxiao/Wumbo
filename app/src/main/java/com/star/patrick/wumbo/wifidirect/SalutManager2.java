...
public class SalutManager2 implements AutoCloseable {

    private Salut network;

    public SalutManager2(Activity activity) {
        SalutDataReceiver dataReceiver = new SalutDataReceiver(activity, new DataReceiver());
        SalutServiceData serviceData = new SalutServiceData("wumbo", HandshakeDispatcherService.PORT, "User " + new Random().nextInt());
