...
public class InviteActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String chName = (String) getIntent().getExtras().getSerializable(CHANNEL_NAME);

        channelNameText = (TextView) findViewById(R.id.channel_title);
        contactListView = (ListView) findViewById(R.id.contact_list);
        continueButton = (ImageButton) findViewById(R.id.continue_creating_channel_button);

        channelNameText.setText(chName);
