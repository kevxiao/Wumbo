...
public class ChannelImpl extends Observable implements Channel {
    ...
    public ChannelImpl(String name, MainActivity context, User me, ChannelManager channelManager) {
        this.name = name;
    ...
    public ChannelImpl(UUID id, String name, MainActivity context, User me, ChannelManager channelManager) {
        this.name = name;
        this.msgs = new MessageListImpl();
        this.id = id;
        this.mainContext = context;
